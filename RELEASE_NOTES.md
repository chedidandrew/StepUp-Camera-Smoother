# StepUp Camera Smoother 0.1.0-alpha.3

This is the third test-build candidate for Minecraft Java Edition 26.2 on Fabric. It remains unreleased until automated verification and the exact candidate jar pass manual testing.
